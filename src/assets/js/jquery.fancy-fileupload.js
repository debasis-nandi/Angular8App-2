...
(function($) {
	...
	$.fn.FancyFileUpload = function(options) {
		...
		var AddFile = function(uploads, e, data) {
			var inforow = $('<tr><td class="ff_fileupload_preview"><div class="ff_fileupload_fileicon"><img src="images/xls-icon.png" id="img_ff_fileUpload"></div><div class="ff_fileupload_actions_mobile"></div></td><td class="ff_fileupload_summary"><div class="ff_fileupload_filename"></div><div class="ff_fileupload_fileinfo"></div><div class="ff_fileupload_buttoninfo ff_fileupload_hidden"></div><div class="ff_fileupload_errors ff_fileupload_hidden"></div><div class="ff_fileupload_progress_background ff_fileupload_hidden"><div class="ff_fileupload_progress_bar"></div></div></td><td class="ff_fileupload_proceed"><a class="process" href="javascript:void(0)">Proceed</a></td><td class="ff_fileupload_actions"></td></tr>');
		...
		var UploadProgress = function(e, data) {
			...
			data.ff_info.uploading = false; // added by debasis
		...
		return this.each(function() {
			...
			var immutableoptions = {
				...
				//fail: UploadFailed, // modified by debasis
				//done: UploadDone, // modified by debasis
				//chunkdone: UploadChunkDone // modified by debasis
			};
